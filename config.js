...
const Call SpaceConfig = {
    ...
    signalingServer: {
        url: 'wss://callspace-production.up.railway.app',
        reconnectDelay: 2000,
...
function loadSavedSettings() {
    const savedSettings = localStorage.getItem('callspace_settings');
    if (savedSettings) {
        try {
...
function saveSettings(settings) {
    try {
        localStorage.setItem('callspace_settings', JSON.stringify(settings));
        return true;
    } catch (e) {
