...
const server = http.createServer((req, res) => {
    ...
    res.end('<h1>Call Space Signaling Server</h1><p>WebSocket endpoint: ws://' + req.headers.host + '</p>');
});
...
server.listen(PORT, () => {
    console.log(`Call Space Signaling Server running on port ${PORT}`);
});
